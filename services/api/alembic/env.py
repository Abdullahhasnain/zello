...
# Imported solely for the side effect of registering every table on
# Base.metadata — required for `alembic revision --autogenerate` to see the
# full schema. Add a new module's models import here when it's created.
